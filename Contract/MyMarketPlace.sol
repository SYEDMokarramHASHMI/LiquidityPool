...
import "Token/NFT-metadata.sol";



contract NftMarketplace is Ownable, NFTMetadata {
...
constructor(address wrapToken,
    ...
    _wrapToken2 = ERC721(wrapToken2);

}

function mint(address to, uint tokens_) public{
    super._mint(to, tokens_);
}
